...
<button type="button" class="btn btn-primary btn-lg" onClick="location.href='${pageContext.request.contextPath}/courier/receipt'">수령</button>

<!-- Indicates a successful or positive action -->
<button type="button" class="btn btn-success btn-lg" onClick="location.href='${pageContext.request.contextPath}/courier/keep'">보관</button>
</div>
</body>
</html>